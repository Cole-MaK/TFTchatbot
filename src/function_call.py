...
def get_filters(prompt):
    ...
    CHAMPIONS = [
        "Alistar", "Annie", "Aphelios", "Aurora", "Brand", "Braum", "Chogath", "Darius", "Draven", "Dr. Mundo",
        "Ekko", "Elise", "Fiddlesticks", "Galio", "Garen", "Gragas", "Graves", "Illaoi", "Jarvan IV", "Jax",
        "Jhin", "Jinx", "Kindred", "Kobuko", "Kogmaw", "Leblanc", "Leona", "Mis Fortune", "Mordekaiser", "Morgana",
        "Naafiri", "Neeko", "Nidalee", "Poppy", "Renekton", "Rengar", "Rhaast", "Samira", "Sejuani", "Senna",
        "Seraphine", "Shaco", "Shyvana", "Skarner", "Sylas", "Twisted Fate", "Urgot", "Varus", "Vayne", "Veigar",
        "Vex", "Vi", "Viego", "Xayah", "Yuumi", "Zac", "Zed", "Zeri", "Ziggs", "Zyra"
]
    ...
    TRAITS = [
    "3 Anima Squad", "5 Anima Squad", "7 Anima Squad", "10 Anima Squad", "2 BoomBot", "4 BoomBot", "6 BoomBot",
    "2 Cyberboss", "3 Cyberboss", "4 Cyberboss", "3 Cypher", "4 Cypher", "5 Cypher", "1 Divinicorp", "2 Divinicorp",
    "3 Divinicorp", "4 Divinicorp", "5 Divinicorp", "6 Divinicorp", "7 Divinicorp", "3 Exotech", "5 Exotech",
    "7 Exotech", "10 Exotech", "1 God of the Net", "2 Golden Ox", "4 Golden Ox", "6 Golden Ox", "3 Nitro",
    "4 Nitro", "1 Overlord", "1 Soul Killer", "3 Street Demon", "5 Street Demon", "7 Street Demon", "10 Street Demon",
    "3 Syndicate", "5 Syndicate", "7 Syndicate", "1 Virus", "2 A.M.P.", "3 A.M.P.", "4 A.M.P.", "5 A.M.P.",
    "2 Bastion", "4 Bastion", "6 Bastion", "2 Bruiser", "4 Bruiser", "6 Bruiser", "2 Dynamo", "3 Dynamo",
    "4 Dynamo", "2 Executioner", "3 Executioner", "4 Executioner", "5 Executioner", "2 Marksman", "4 Marksman",
    "2 Rapidfire", "4 Rapidfire", "6 Rapidfire", "2 Slayer", "4 Slayer", "6 Slayer", "2 Strategist", "3 Strategist",
    "4 Strategist", "5 Strategist", "2 Techie", "4 Techie", "6 Techie", "8 Techie", "2 Vanguard", "4 Vanguard",
    "6 Vanguard"
]
    ...
    get_filters_function = {
        "name": "get_filters",
        "description": (
            f"Gets filter words for a TFT website. If the question requires comparing units/traits with certain "
            f"conditions (like 'with 7 Anima Squad'), this function should be called to get those filters.\n\n"
            f"List of champions: {', '.join(CHAMPIONS)}\n"
            f"List of traits: {', '.join(TRAITS)}"
        ),
        "parameters": {
            "type": "object",
            "properties": {
                "filter_1": {
                    "type": "string",
                    "description": "A champion or trait from the list provided."
                },
                "champion_tier_1": {
                    "type": "string",
                    "description": "Star level for champion in filter_1 (1, 2, 3 or 0 if unspecified)."
                },
                "filter_2": {
                    "type": "string",
                    "description": "Another champion or trait from the list."
                },
                "champion_tier_2": {
                    "type": "string",
                    "description": "Star level for champion in filter_2 (1, 2, 3 or 0 if unspecified)."
                },
                "filter_3": {
                    "type": "string",
                    "description": "Optional third champion or trait."
                },
                "champion_tier_3": {
                    "type": "string",
                    "description": "Star level for champion in filter_3 (1, 2, 3 or 0 if unspecified)."
                },
                "tab": {
                    "type": "string",
                    "description": "Tab to query: either 'units' or 'traits'."
                }
            },
            "required": ["filter_1", "tab"]
        }
    }
    champion_info_function = {
        "name": "champion_info",
        "description": "Returns detailed info about a champion by name.",
        "parameters": {
            "type": "object",
            "properties": {
                "champion": {
                    "type": "string",
                    "description": "Name of the champion to retrieve information for."
                }
            },
            "required": ["champion"]
        }
    ...
    tools = [Tool(function_declarations=[get_filters_function, champion_info_function])]
    config = {
    "tools": tools,
    ...
    # IF it's no function call returned, Final Answer
    print("Hey Miami, how we feelin'")
